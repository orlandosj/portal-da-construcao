						...
						<div id="contactFormArea">
							<form action="comentarios.php" method="post" id="cForm">
								<fieldset>
									...
									<textarea cols="50" rows="6" name="comment" id="comment" class="inputtextarea" tabindex="4" required></textarea>
									<span class="hint">Digite seu comentário</span><br /><br />
									<label>
										<input class="button"  type="submit" name="comentar" id="button" value="Enviar" tabindex="5" />										
									</label>									
								</fieldset>
							</form>
						</div>
