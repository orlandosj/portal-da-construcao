...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	/*Página para CRUD de comentários*/
		...
		function geraSenha($usuario, $email){
			...
			$query = mysql_query($sql) or die("<script language=JavaScript>alert(\"Falha na execução!\");</script>");
			...
			if($resultado['email'] == $email){
				...
				$result = mysql_query($sql) or die("<script language=JavaScript>alert(\"Falha na execução!\");</script>");
				
				$nome = $resultado['nome'];
				$mensagem = 'Sua senha para acesso ao Portal Feras da Construção foi alterada para: '.$senha;
				
				//envia email com nova senha 
				if (smtpmailer($email, 'orlandosj@gmail.com', $nome, 'Alteração de senha', $mensagem)) {
				...
				echo "<script>alert('Nome de usuário e/ou email incorretos (diferentes do cadastro)')</script>";
			}		
		}	
		...
		<div id="maincontent">
			<div id="main">
				<div id="maintext">
					...
					<div id="portal">
						Preencha o formulário abaixo e um email será enviado para você com a sua nova senha.
					</div>
						...
						<div id="contactFormArea">
							<form action="" method="post" id="cForm">
								<fieldset>
									...
									<span class="hint">Informe seu nome de usuário (número do cpf)</span><br /><br />
									
									<label for="email">Email:</label>
									<input class="inputcadastro" type="text" size="25" name="email" id="email" value="" tabindex="2" required />
									<span class="hint">Informe o email que você cadastrou no site</span><br /><br />
