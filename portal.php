...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>O Portal Feras da Construção</title>
		...
		<div id="maincontent">
			<div id="main">
				<div id="maintext">
					...
					<h2>O Portal Feras da Construção</h2>
					<p></p>
					
					<div id="portal">
					
						A ideia da criação do Portal Feras da Construção surgiu a partir do momento em que seu criador resolveu construir sua casa. 
